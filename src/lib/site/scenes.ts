...
export const SITE_SCENES: SceneDef[] = [
  ...
  { key: "service/headshot-booth", label: "Headshot Booth", kind: "pool", service: "headshot-booth", path: "/services/headshot-booth",
  ...
  { key: "service/anti-booth", label: "Anti-Booth", kind: "pool", service: "anti-booth", path: "/services/anti-booth",
    description: "“Recent frames” gallery on the service page (shows ~8)" },
