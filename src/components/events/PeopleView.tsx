...
/**
 * The crop math lives in ONE place now — the naming engine's review queue
 * shows the identical crop, and two copies of face geometry is how two
 * surfaces drift apart on the same face.
 */
function FaceCrop({ face }: { face: PersonFace }) {
  return <FaceCircleCrop face={face} />;
}
